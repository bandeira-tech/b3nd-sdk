 ...
 */
export Schema = Record<string, ValidationFn>;
...
export interface NodeProtocolInterface {
   ...
   */
  write(uri, value): Promise<WriteResult<T>>;
   ...
   */
  list(uri, options?: ListOptions): Promise<ListResult>;
   ...
   */
  delete(uri): Promise<DeleteResult>;
